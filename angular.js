/**
 * @license AngularJS v1.2.15-build.local+sha.c5f2f58
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.15-build.local+sha.c5f2f58/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.15-build.local+sha.c5f2f58',    // all of these placeholder strings will be replaced by grunt's
